package dev.joaoshiozo.insomnia.core.api.gui.clickgui;

import dev.joaoshiozo.insomnia.InsomniaMod;
import dev.joaoshiozo.insomnia.core.api.gui.clickgui.button.ModuleButton;
...
public class Window
{
    ...
    public Window(Category category, int x, int y, int w, int h)
    {
        ...
        for (Module module : InsomniaMod.moduleManager.getModules(category))
        {
