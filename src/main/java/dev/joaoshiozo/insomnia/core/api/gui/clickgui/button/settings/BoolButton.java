...
public class BoolButton extends SettingButton
{
    ...
    public void render(int mX, int mY)
    {
        ...
        else
        {
            ...
            {
                InsomniaMod.clickGUI.drawGradient(getX(), getY(), getX() + getW(), getY() + getH(), new Color(220, 220, 220, 232).getRGB(), new Color(218, 218, 218, 232).getRGB());
            }
            else
            {
                InsomniaMod.clickGUI.drawGradient(getX(), getY(), getX() + getW(), getY() + getH(), new Color(240, 240, 240, 232).getRGB(), new Color(238, 238, 238, 232).getRGB());
            }
